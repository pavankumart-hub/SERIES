...
# Example stock list (you can add more)
stocks = ['AADHARHFC.NS', 'AARTIDRUGS.NS', 'AARTIIND.NS', 'AARTIPHARM.NS', 'AAVAS.NS', 'ABB.NS', 'ABBOTINDIA.NS', 'ABCAPITAL.NS', 'ABDL.NS', 'ABFRL.NS', 'ABLBL.NS', 'ABREL.NS', 'ABSLAMC.NS', 'ACC.NS', 'ACE.NS', 'ACI.NS', 'ACMESOLAR.NS', 'ACUTAAS.NS', 'ADANIENSOL.NS', 'ADANIENT.NS', 'ADANIGREEN.NS', 'ADANIPORTS.NS', 'ADANIPOWER.NS', 'ADVENZYMES.NS', 'AEGISLOG.NS', 'AEGISVOPAK.NS', 'AETHER.NS', 'AFCONS.NS', 'AFFLE.NS', 'AGARWALEYE.NS', 'AGI.NS', 'AHLUCONT.NS', 'AIAENG.NS', 'AIIL.NS', 'AJANTPHARM.NS', 'AJAXENGG.NS', 'AKUMS.NS', 'AKZOINDIA.NS', 'ALIVUS.NS', 'ALKEM.NS', 'ALKYLAMINE.NS', 'ALLCARGO.NS', 'ALOKINDS.NS', 'AMBER.NS', 'AMBUJACEM.NS', 'ANANDRATHI.NS', 'ANANTRAJ.NS', 'ANGELONE.NS', 'ANUP.NS', 'ANURAS.NS', 'APARINDS.NS', 'APLAPOLLO.NS', 'APLLTD.NS', 'APOLLOHOSP.NS', 'APOLLOTYRE.NS', 'APTUS.NS', 'ARVIND.NS', 'ARVINDFASN.NS', 'ASAHIINDIA.NS', 'ASHOKA.NS', 'ASHOKLEY.NS', 'ASIANPAINT.NS', 'ASKAUTOLTD.NS', 'ASTERDM.NS', 'ASTRAL.NS', 'ASTRAMICRO.NS', 'ASTRAZEN.NS', 'ATGL.NS', 'ATHERENERG.NS', 'ATUL.NS', 'AUBANK.NS', 'AURIONPRO.NS', 'AUROPHARMA.NS', 'AVALON.NS', 'AVANTIFEED.NS', 'AWFIS.NS', 'AWL.NS', 'AXISBANK.NS', 'AZAD.NS', 'BAJAJELEC.NS', 'BAJAJFINSV.NS', 'BAJAJHFL.NS', 'BAJAJHLDNG.NS', 'BAJFINANCE.NS', 'BALAMINES.NS', 'BALKRISIND.NS', 'BALRAMCHIN.NS', 'BALUFORGE.NS', 'BANCOINDIA.NS', 'BANDHANBNK.NS', 'BANKBARODA.NS', 'BANKINDIA.NS', 'BASF.NS', 'BATAINDIA.NS', 'BAYERCROP.NS', 'BBL.NS', 'BBTC.NS', 'BDL.NS', 'BECTORFOOD.NS', 'BEL.NS', 'BELRISE.NS', 'BEML.NS', 'BERGEPAINT.NS', 'BHARATFORG.NS', 'BHARTIARTL.NS', 'BHARTIHEXA.NS', 'BHEL.NS', 'BIKAJI.NS', 'BIOCON.NS', 'BIRLACORPN.NS', 'BLACKBUCK.NS', 'BLS.NS', 'BLUEDART.NS', 'BLUEJET.NS', 'BLUESTARCO.NS', 'BORORENEW.NS', 'BOSCHLTD.NS', 'BPCL.NS', 'BRIGADE.NS', 'BRITANNIA.NS', 'BSE.NS', 'BSOFT.NS', 'CAMPUS.NS', 'CAMS.NS', 'CANBK.NS', 'CANFINHOME.NS', 'CAPLIPOINT.NS', 'CARBORUNIV.NS', 'CARTRADE.NS', 'CASTROLIND.NS', 'CCL.NS', 'CDSL.NS', 'CEATLTD.NS', 'CEIGALL.NS', 'CELLO.NS', 'CEMPRO.NS', 'CENTRALBK.NS', 'CENTURYPLY.NS', 'CERA.NS', 'CESC.NS', 'CGCL.NS', 'CGPOWER.NS', 'CHALET.NS', 'CHAMBLFERT.NS', 'CHENNPETRO.NS', 'CHOICEIN.NS', 'CHOLAFIN.NS', 'CHOLAHLDNG.NS', 'CIEINDIA.NS', 'CIGNITITEC.NS', 'CIPLA.NS', 'CLEAN.NS', 'CMSINFO.NS', 'COALINDIA.NS', 'COCHINSHIP.NS', 'COFORGE.NS', 'COHANCE.NS', 'COLPAL.NS', 'CONCOR.NS', 'CONCORDBIO.NS', 'COROMANDEL.NS', 'CRAFTSMAN.NS', 'CREDITACC.NS', 'CRISIL.NS', 'CROMPTON.NS', 'CSBBANK.NS', 'CUB.NS', 'CUMMINSIND.NS', 'CYIENT.NS', 'CYIENTDLM.NS', 'DABUR.NS', 'DALBHARAT.NS', 'DATAMATICS.NS', 'DATAPATTNS.NS', 'DBL.NS', 'DBREALTY.NS', 'DCAL.NS', 'DCBBANK.NS', 'DCMSHRIRAM.NS', 'DEEPAKFERT.NS', 'DEEPAKNTR.NS', 'DELHIVERY.NS', 'DEVYANI.NS', 'DHANUKA.NS', 'DIACABS.NS', 'DIVISLAB.NS', 'DIXON.NS', 'DLF.NS', 'DMART.NS', 'DODLA.NS', 'DOMS.NS', 'DRREDDY.NS', 'DYNAMATECH.NS', 'EASEMYTRIP.NS', 'ECLERX.NS', 'EDELWEISS.NS', 'EICHERMOT.NS', 'EIDPARRY.NS', 'EIEL.NS', 'EIHOTEL.NS', 'ELECON.NS', 'ELECTCAST.NS', 'ELGIEQUIP.NS', 'EMAMILTD.NS', 'EMBDL.NS', 'EMCURE.NS', 'EMIL.NS', 'EMUDHRA.NS', 'ENDURANCE.NS', 'ENGINERSIN.NS', 'ENRIN.NS', 'ENTERO.NS', 'EPIGRAL.NS', 'EPL.NS', 'EQUITASBNK.NS', 'ERIS.NS', 'ESCORTS.NS', 'ETERNAL.NS', 'ETHOSLTD.NS', 'EUREKAFORB.NS', 'EXIDEIND.NS', 'FACT.NS', 'FDC.NS', 'FEDERALBNK.NS', 'FIEMIND.NS', 'FINCABLES.NS', 'FINEORG.NS', 'FINPIPE.NS', 'FIRSTCRY.NS', 'FIVESTAR.NS', 'FLUOROCHEM.NS', 'FORCEMOT.NS', 'FORTIS.NS', 'FSL.NS', 'GABRIEL.NS', 'GAEL.NS', 'GAIL.NS', 'GALLANTT.NS', 'GANECOS.NS', 'GANESHHOU.NS', 'GARFIBRES.NS', 'GATEWAY.NS', 'GESHIP.NS', 'GHCL.NS', 'GICRE.NS', 'GILLETTE.NS', 'GLAND.NS', 'GLAXO.NS', 'GLENMARK.NS', 'GMDCLTD.NS', 'GMMPFAUDLR.NS', 'GMRAIRPORT.NS', 'GNFC.NS', 'GODFRYPHLP.NS', 'GODIGIT.NS', 'GODREJAGRO.NS', 'GODREJCP.NS', 'GODREJIND.NS', 'GODREJPROP.NS', 'GOKEX.NS', 'GPIL.NS', 'GPPL.NS', 'GRANULES.NS', 'GRAPHITE.NS', 'GRASIM.NS', 'GRAVITA.NS', 'GREAVESCOT.NS', 'GREENPANEL.NS', 'GRINFRA.NS', 'GRSE.NS', 'GRWRHITECH.NS', 'GSFC.NS', 'GSPL.NS', 'GUJGASLTD.NS', 'GULFOILLUB.NS', 'HAL.NS', 'HAPPSTMNDS.NS', 'HAVELLS.NS', 'HBLENGINE.NS', 'HCC.NS', 'HCG.NS', 'HCLTECH.NS', 'HDFCAMC.NS', 'HDFCBANK.NS', 'HDFCLIFE.NS', 'HEG.NS', 'HEMIPROP.NS', 'HERITGFOOD.NS', 'HEROMOTOCO.NS', 'HEXT.NS', 'HFCL.NS', 'HGINFRA.NS', 'HIKAL.NS', 'HINDALCO.NS', 'HINDCOPPER.NS', 'HINDPETRO.NS', 'HINDUNILVR.NS', 'HINDZINC.NS', 'HOMEFIRST.NS', 'HONASA.NS', 'HONAUT.NS', 'HSCL.NS', 'HUDCO.NS', 'HYUNDAI.NS', 'ICICIBANK.NS', 'ICICIGI.NS', 'ICICIPRULI.NS', 'ICIL.NS', 'IDBI.NS', 'IDEA.NS', 'IDFCFIRSTB.NS', 'IEX.NS', 'IFBIND.NS', 'IFCI.NS', 'IGIL.NS', 'IGL.NS', 'IIFL.NS', 'IIFLCAPS.NS', 'IKS.NS', 'IMAGICAA.NS', 'IMFA.NS', 'INDGN.NS', 'INDHOTEL.NS', 'INDIACEM.NS', 'INDIAGLYCO.NS', 'INDIAMART.NS', 'INDIANB.NS', 'INDIASHLTR.NS', 'INDIGO.NS', 'INDIGOPNTS.NS', 'INDUSINDBK.NS', 'INDUSTOWER.NS', 'INFY.NS', 'INGERRAND.NS', 'INNOVACAP.NS', 'INOXGREEN.NS', 'INOXINDIA.NS', 'INOXWIND.NS', 'INTELLECT.NS', 'IOB.NS', 'IOC.NS', 'IONEXCHANG.NS', 'IPCALAB.NS', 'IRB.NS', 'IRCON.NS', 'IRCTC.NS', 'IREDA.NS', 'IRFC.NS', 'ISGEC.NS', 'ITC.NS', 'ITCHOTELS.NS', 'ITI.NS', 'IXIGO.NS', 'JAIBALAJI.NS', 'JAMNAAUTO.NS', 'JBCHEPHARM.NS', 'JBMA.NS', 'JINDALSAW.NS', 'JINDALSTEL.NS', 'JINDWORLD.NS', 'JIOFIN.NS', 'JISLJALEQS.NS', 'JKCEMENT.NS', 'JKIL.NS', 'JKLAKSHMI.NS', 'JKPAPER.NS', 'JKTYRE.NS', 'JMFINANCIL.NS', 'JPPOWER.NS', 'JSFB.NS', 'JSL.NS', 'JSWENERGY.NS', 'JSWINFRA.NS', 'JSWSTEEL.NS', 'JUBLFOOD.NS', 'JUBLINGREA.NS', 'JUBLPHARMA.NS', 'JUSTDIAL.NS', 'JWL.NS', 'JYOTHYLAB.NS', 'JYOTICNC.NS', 'KAJARIACER.NS', 'KALYANKJIL.NS', 'KARURVYSYA.NS', 'KAYNES.NS', 'KEC.NS', 'KEI.NS', 'KFINTECH.NS', 'KIMS.NS', 'KIRLOSBROS.NS', 'KIRLOSENG.NS', 'KIRLPNU.NS', 'KITEX.NS', 'KNRCON.NS', 'KOTAKBANK.NS', 'KPIGREEN.NS', 'KPIL.NS', 'KPITTECH.NS', 'KPRMILL.NS', 'KRBL.NS', 'KRN.NS', 'KSB.NS', 'KSCL.NS', 'KSL.NS', 'KTKBANK.NS', 'LALPATHLAB.NS', 'LATENTVIEW.NS', 'LAURUSLABS.NS', 'LEMONTREE.NS', 'LICHSGFIN.NS', 'LICI.NS', 'LINDEINDIA.NS', 'LLOYDSENGG.NS', 'LLOYDSENT.NS', 'LLOYDSME.NS', 'LMW.NS', 'LODHA.NS', 'LT.NS', 'LTF.NS', 'LTFOODS.NS', 'LTIM.NS', 'LTTS.NS', 'LUMAXTECH.NS', 'LUPIN.NS', 'LUXIND.NS', 'LXCHEM.NS', 'MAHABANK.NS', 'MAHLIFE.NS', 'MAHSCOOTER.NS', 'MAHSEAMLES.NS', 'MANAPPURAM.NS', 'MANINFRA.NS', 'MANKIND.NS', 'MANORAMA.NS', 'MANYAVAR.NS', 'MAPMYINDIA.NS', 'MARICO.NS', 'MARKSANS.NS', 'MARUTI.NS', 'MASTEK.NS', 'MAXESTATES.NS', 'MAXHEALTH.NS', 'MAZDOCK.NS', 'MCX.NS', 'MEDANTA.NS', 'MEDPLUS.NS', 'METROPOLIS.NS', 'MFSL.NS', 'MGL.NS', 'MIDHANI.NS', 'MINDACORP.NS', 'MMTC.NS', 'MOIL.NS', 'MOTHERSON.NS', 'MOTILALOFS.NS', 'MPHASIS.NS', 'MRF.NS', 'MRPL.NS', 'MSTCLTD.NS', 'MSUMI.NS', 'MTARTECH.NS', 'MUTHOOTFIN.NS', 'NATCOPHARM.NS', 'NATIONALUM.NS', 'NAUKRI.NS', 'NAVA.NS', 'NAVINFLUOR.NS', 'NAZARA.NS', 'NBCC.NS', 'NCC.NS', 'NEOGEN.NS', 'NESCO.NS', 'NESTLEIND.NS', 'NETWEB.NS', 'NEULANDLAB.NS', 'NEWGEN.NS', 'NFL.NS', 'NH.NS', 'NHPC.NS', 'NIACL.NS', 'NIVABUPA.NS', 'NLCINDIA.NS', 'NMDC.NS', 'NSLNISP.NS', 'NTPC.NS', 'NTPCGREEN.NS', 'NUVAMA.NS', 'NUVOCO.NS', 'NYKAA.NS', 'OBEROIRLTY.NS', 'OFSS.NS', 'OIL.NS', 'OLAELEC.NS', 'OLECTRA.NS', 'ONESOURCE.NS', 'ONGC.NS', 'OPTIEMUS.NS', 'ORCHPHARMA.NS', 'ORIENTCEM.NS', 'OSWALPUMPS.NS', 'PAGEIND.NS', 'PARADEEP.NS', 'PARAS.NS', 'PARKHOTELS.NS', 'PATANJALI.NS', 'PATELENG.NS', 'PAYTM.NS', 'PCBL.NS', 'PCJEWELLER.NS', 'PERSISTENT.NS', 'PETRONET.NS', 'PFC.NS', 'PFIZER.NS', 'PGEL.NS', 'PGHH.NS', 'PGIL.NS', 'PHOENIXLTD.NS', 'PIDILITIND.NS', 'PIIND.NS', 'PNB.NS', 'PNBHOUSING.NS', 'PNCINFRA.NS', 'PNGJL.NS', 'POLICYBZR.NS', 'POLYCAB.NS', 'POLYMED.NS', 'POLYPLEX.NS', 'POONAWALLA.NS', 'POWERGRID.NS', 'POWERINDIA.NS', 'POWERMECH.NS', 'PPLPHARMA.NS', 'PRAJIND.NS', 'PREMIERENE.NS', 'PRESTIGE.NS', 'PRICOLLTD.NS', 'PRINCEPIPE.NS', 'PRIVISCL.NS', 'PRSMJOHNSN.NS', 'PRUDENT.NS', 'PTC.NS', 'PTCIL.NS', 'PURVA.NS', 'PVRINOX.NS', 'QUESS.NS', 'RADICO.NS', 'RAILTEL.NS', 'RAIN.NS', 'RAINBOW.NS', 'RAJESHEXPO.NS', 'RALLIS.NS', 'RAMCOCEM.NS', 'RATEGAIN.NS', 'RAYMONDLSL.NS', 'RBA.NS', 'RBLBANK.NS', 'RCF.NS', 'RECLTD.NS', 'REDINGTON.NS', 'REFEX.NS', 'RELAXO.NS', 'RELIANCE.NS', 'RELIGARE.NS', 'RELINFRA.NS', 'RENUKA.NS', 'RHIM.NS', 'RITES.NS', 'RKFORGE.NS', 'ROUTE.NS', 'RPOWER.NS', 'RRKABEL.NS', 'RTNINDIA.NS', 'RTNPOWER.NS', 'RVNL.NS', 'SAFARI.NS', 'SAGILITY.NS', 'SAIL.NS', 'SAILIFE.NS', 'SAMHI.NS', 'SAMMAANCAP.NS', 'SANDUMA.NS', 'SANOFI.NS', 'SANOFICONR.NS', 'SANSERA.NS', 'SAPPHIRE.NS', 'SARDAEN.NS', 'SAREGAMA.NS', 'SBFC.NS', 'SBICARD.NS', 'SBILIFE.NS', 'SBIN.NS', 'SCHAEFFLER.NS', 'SCHNEIDER.NS', 'SCI.NS', 'SENCO.NS', 'SFL.NS', 'SHAILY.NS', 'SHAKTIPUMP.NS', 'SHARDACROP.NS', 'SHARDAMOTR.NS', 'SHAREINDIA.NS', 'SHILPAMED.NS', 'SHREECEM.NS', 'SHRIPISTON.NS', 'SHRIRAMFIN.NS', 'SHYAMMETL.NS', 'SIEMENS.NS', 'SIGNATURE.NS', 'SJVN.NS', 'SKFINDIA.NS', 'SKIPPER.NS', 'SKYGOLD.NS', 'SOBHA.NS', 'SOLARINDS.NS', 'SONACOMS.NS', 'SONATSOFTW.NS', 'SOUTHBANK.NS', 'SPARC.NS', 'SRF.NS', 'STAR.NS', 'STARCEMENT.NS', 'STARHEALTH.NS', 'STLTECH.NS', 'STYRENIX.NS', 'SUBROS.NS', 'SUDARSCHEM.NS', 'SUMICHEM.NS', 'SUNDARMFIN.NS', 'SUNFLAG.NS', 'SUNPHARMA.NS', 'SUNTECK.NS', 'SUNTV.NS', 'SUPREMEIND.NS', 'SUPRIYA.NS', 'SURYAROSNI.NS', 'SUZLON.NS', 'SWANCORP.NS', 'SWIGGY.NS', 'SWSOLAR.NS', 'SYMPHONY.NS', 'SYNGENE.NS', 'SYRMA.NS', 'TANLA.NS', 'TARC.NS', 'TARIL.NS', 'TATACHEM.NS', 'TATACOMM.NS', 'TATACONSUM.NS', 'TATAELXSI.NS', 'TATAINVEST.NS', 'TATAPOWER.NS', 'TATASTEEL.NS', 'TATATECH.NS', 'TBOTEK.NS', 'TCS.NS', 'TDPOWERSYS.NS', 'TEAMLEASE.NS', 'TECHM.NS', 'TECHNOE.NS', 'TEGA.NS', 'TEJASNET.NS', 'TEXRAIL.NS', 'THANGAMAYL.NS', 'THELEELA.NS', 'THERMAX.NS', 'THOMASCOOK.NS', 'THYROCARE.NS', 'TI.NS', 'TIINDIA.NS', 'TIMETECHNO.NS', 'TIMKEN.NS', 'TIPSMUSIC.NS', 'TITAGARH.NS', 'TITAN.NS', 'TMCV.NS', 'TMPV.NS', 'TORNTPHARM.NS', 'TORNTPOWER.NS', 'TRANSRAILL.NS', 'TRENT.NS', 'TRIDENT.NS', 'TRITURBINE.NS', 'TRIVENI.NS', 'TTML.NS', 'TVSMOTOR.NS', 'TVSSCS.NS', 'UBL.NS', 'UCOBANK.NS', 'UJJIVANSFB.NS', 'ULTRACEMCO.NS', 'UNIMECH.NS', 'UNIONBANK.NS', 'UNITDSPR.NS', 'UNOMINDA.NS', 'UPL.NS', 'USHAMART.NS', 'UTIAMC.NS', 'VAIBHAVGBL.NS', 'VARROC.NS', 'VBL.NS', 'VEDL.NS', 'VENTIVE.NS', 'VESUVIUS.NS', 'VGUARD.NS', 'VIJAYA.NS', 'VINATIORGA.NS', 'VIPIND.NS', 'VMART.NS', 'VMM.NS', 'VOLTAMP.NS', 'VOLTAS.NS', 'VSTIND.NS', 'VTL.NS', 'WAAREEENER.NS', 'WAAREERTL.NS', 'WABAG.NS', 'WEBELSOLAR.NS', 'WELCORP.NS', 'WELENT.NS', 'WELSPUNLIV.NS', 'WESTLIFE.NS', 'WHIRLPOOL.NS', 'WIPRO.NS', 'WOCKPHARMA.NS', 'YATHARTH.NS', 'YESBANK.NS', 'ZAGGLE.NS', 'ZEEL.NS', 'ZENSARTECH.NS', 'ZENTEC.NS', 'ZFCVINDIA.NS', 'ZYDUSLIFE.NS', 'ZYDUSWELL.NS']
# Dropdown
...
if run_forecast_btn:
    try:
        ...
        if data is None or data.empty or 'Low' not in data.columns or 'Open' not in data.columns:
            st.error("Low/Open price data not available. Check ticker symbol.")
            st.stop()
        ...
        low_open_data = low_open_data[np.isfinite(low_open_data['Low_Open_Pct'])]

        if len(low_open_data) < 30:
            st.error(f"Not enough data points ({len(low_open_data)}). Need at least 30 days.")
            st.stop()

        st.header(f"Low-Open Analysis for {ticker}")

        # Display basic statistics
        st.subheader("📊 Basic Statistics")
        col1, col2, col3, col4 = st.columns(4)

        current_pct = float(low_open_data['Low_Open_Pct'].iloc[-1])
        avg_pct = float(low_open_data['Low_Open_Pct'].mean())
        max_pct = float(low_open_data['Low_Open_Pct'].max())
        min_pct = float(low_open_data['Low_Open_Pct'].min())
        std_pct = float(low_open_data['Low_Open_Pct'].std())
        ...
        # Plot historical Low-Open percentage
        st.subheader("📈 Historical Low-Open Percentage")
        fig1, ax1 = plt.subplots(figsize=(12, 6))
        ...
        ax1.set_xlabel('Date')
        ax1.set_ylabel('Percentage (%)')
        ax1.set_title(f'{ticker} Historical (Open-Low)/Open Percentage')
        ax1.legend()
        ax1.grid(alpha=0.3)
        plt.xticks(rotation=45)
        plt.tight_layout()
        ...
        adf_stat, adf_p, adf_err = safe_adfuller(low_open_data['Low_Open_Pct'])
        ...
        plot_acf(low_open_data['Low_Open_Pct'], ax=ax1, lags=20)
        ax1.set_title("Autocorrelation Function (ACF)")
        plot_pacf(low_open_data['Low_Open_Pct'], ax=ax2, lags=20)
        ax2.set_title("Partial Autocorrelation Function (PACF)")
        plt.tight_layout()
        st.pyplot(fig2)
        ...
        with st.spinner("Fitting ARIMA model..."):
            model, error = fit_arima_model(low_open_data['Low_Open_Pct'], p, d, q)
            ...
            if len(fitted_values) > d:
                ...
                fitted_dates_clean = low_open_data.index[len(low_open_data) - len(fitted_values) + d:]
            else:
                fitted_values_clean = fitted_values
                fitted_dates_clean = low_open_data.index[len(low_open_data) - len(fitted_values):]
            ...
            # Generate future dates
            last_date = low_open_data.index[-1]
        ...
        ax3.plot(fitted_dates_clean, fitted_values_clean,
                label='ARIMA Fitted', linewidth=2, linestyle='--', color='orange')
        ...
        ax4.set_title(f'ARIMA({p},{d},{q}): {forecast_days}-Day Low-Open Percentage Forecast')
        ax4.legend()
        ax4.grid(alpha=0.3)
        plt.xticks(rotation=45)
        plt.tight_layout()
        ...
        with col1:
            if forecast_trend > 1.0:
                ...
                st.info("➡️ Stable Intraday Low Patterns")
                st.write("Consistent open-to-low patterns expected")
